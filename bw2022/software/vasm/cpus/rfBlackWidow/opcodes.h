	"cmp.eq",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x0210000000LL},
	"cmp.lt",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x0200000000LL},
	"cmp.ge",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x0204000000LL},
	"cmp.le",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x0208000000LL},
	"cmp.gt",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x020C000000LL},
	"cmp.ne",				{ PT1,PT2,RB,RA}			,{BWCOM,  0x0214000000LL},
	"cmpi.eq",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x0290000000LL},
	"cmpi.lt",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x0280000000LL},
	"cmpi.ge",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x0284000000LL},
	"cmpi.le",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x0288000000LL},
	"cmpi.gt",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x028C000000LL},
	"cmpi.ne",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x0294000000LL},
	"cmpu.eq",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x0250000000LL},
	"cmpu.lt",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x0240000000LL},
	"cmpu.ge",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x0244000000LL},
	"cmpu.le",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x0248000000LL},
	"cmpu.gt",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x024C000000LL},
	"cmpu.ne",			{ PT1,PT2,RB,RA}			,{BWCOM,  0x0254000000LL},
	"cmpui.eq",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02B0000000LL},
	"cmpui.lt",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02A0000000LL},
	"cmpui.ge",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02A4000000LL},
	"cmpui.le",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02A8000000LL},
	"cmpui.gt",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02AC000000LL},
	"cmpui.ne",			{ PT1,PT2,SI6,RA}			,{BWCOM,  0x02B4000000LL},
	...
	"bra",					{ BD }								,{BWCOM,	0x1A00000000LL},
	"bsr",					{ BD }								,{BWCOM,	0x1C00000000LL},
	"bmr",					{ BD }								,{BWCOM,	0x1E00000000LL},
