...
#define CPU_TYPE_128          (0x0800000000000000ULL)
#define CPU_TYPE_BW           (0x0400000000000000ULL)

/* Shortcuts for PPC instruction sets */
#undef  PPC
#define BWCOM		(CPU_TYPE_BW | CPU_TYPE_COMMON | CPU_TYPE_128)
